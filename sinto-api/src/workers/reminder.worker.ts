 ...
 * Daily scheduler that finds users with reminders enabled and logs notification intent. TODO: integrate BullMQ + FCM for real push delivery.
 *
 * Exports: scheduleReminders, startReminderWorker
 * Depends on: prisma
 */
