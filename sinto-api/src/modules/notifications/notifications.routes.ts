 ...
 * Endpoints: PATCH /users/me/notifications, GET /users/me/devices, POST /users/me/devices, DELETE /users/me/devices/:token
 * All protected by authGuard. Depends on: notifications.service
 */
