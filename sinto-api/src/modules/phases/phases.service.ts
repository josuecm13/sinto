/**
 * MODULE: Phase content service
 * Returns seeded phase guidance (exercise, nutrition, tips, dangers) and computes current cycle phase from startDate.
 *
 * Exports: listPhases, getPhaseContent, getCurrentPhase
 * Depends on: prisma
 */
