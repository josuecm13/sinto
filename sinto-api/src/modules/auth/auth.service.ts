/**
 * MODULE: Auth service
 * Handles user registration (bcrypt hash), login, JWT issuance, refresh token rotation (Redis), and logout (revoke token).
 *
 * Exports: registerUser, loginUser, refreshTokens, logoutUser
 * Depends on: prisma, redis, bcryptjs, JWT_SECRET
 */
