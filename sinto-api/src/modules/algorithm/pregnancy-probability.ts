/**
 * MODULE: Pregnancy probability
 * Pure functions — no DB or Fastify imports. Calculates daily conception probability using a curve relative to estimated ovulation.
 *
 * Exports: calculateDailyProbabilities, type DailyProbability
 */
